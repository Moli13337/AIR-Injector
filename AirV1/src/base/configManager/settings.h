...
struct settings
{
	...
	inline static float Menu_PrimaryColor[4]{ 0.36f, 0.29f, 0.78f, 1.0f };
	inline static float Menu_SecondaryColor[4]{ 1.0f, 1.0f, 1.0f, 0.5f };
	inline static float Menu_BackgroundColor[4]{ 0.025f, 0.025f, 0.03f, 0.96f };
	inline static float Menu_ChildBackgroundColor[4]{ 0.045f, 0.045f, 0.052f, 0.98f };
	inline static float Menu_OutlineColor[4]{ 0.0f, 0.0f, 0.0f, 0.78f };
	inline static float Menu_DetachButtonColor[4]{ 1.0f, 0.0f, 0.0f, 0.5f };

	inline static float Menu_WindowRounding = 2.0f;
	inline static float Menu_ComponentsRounding = 2.0f;
	...
	inline static float Menu_ThemeHue = 0.69f;

	// Hud
	inline static bool Hud_DisableAllRendering = false;
	inline static bool Hud_Watermark = false;
	...
	inline static bool Hud_ShowKeybinds = false;
	...
	inline static float AL_backgroundPadding = 0;
	inline static float AL_backgroundColor[4]{ 0.f, 0.f, 0.f, 0.f };
	inline static float AL_backgroundRoundness = 5.f;
    inline static int AL_colorMode = 1; // Default to RGB Wave
	...
	inline static bool AA_aimAssistFeedback = false;
	...
	inline static int Reach_Chance = 100;

	// Sprint Reset
	inline static bool SR_Enabled = false;
	inline static int SR_Key = 0x0;
	inline static float SR_DelayBetween = .5f;
	inline static float SR_LetGoDelay = 1.0f;

	// Sprint
	inline static bool S_Enabled = false;
	inline static int S_Key = 0x0;
	inline static bool S_WhenStill = false;
	inline static bool S_InWater = false;
	inline static bool S_InAir = false;
	...
	inline static int BA_SneakDelay = 100;
	inline static int BA_UnSneakDelay = 150;
	...
	inline static float Velocity_JRReactionTime = 100.0f;
	inline static int Velocity_JRChange = 100;
