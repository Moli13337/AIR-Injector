...
bool configmanager::LoadConfig(int index)
{
	...
	if (index < 0 || index >= static_cast<int>(configList.size()))
		return false;

	std::string name = configList[index];
	return LoadConfig(name.c_str());
}
...
bool configmanager::SettingsToJson(json& j)
{
	...
	j["AL_rgbSpeed"] = settings::AL_rgbSpeed;
	...
	j["Reach_Chance"] = settings::Reach_Chance;
	...
	j["Sprint_InWater"] = settings::S_InWater;
	j["Sprint_InAir"] = settings::S_InAir;
	j["Sprint_WhenStill"] = settings::S_WhenStill;
	...
	j["BA_SneakDelay"] = settings::BA_SneakDelay;
	j["BA_UnSneakDelay"] = settings::BA_UnSneakDelay;
	...
	// Inventory Sorter
	j["IS_Enabled"] = settings::IS_Enabled;
	j["IS_Key"] = settings::IS_Key;
	j["IS_Delay"] = settings::IS_Delay;
...
bool configmanager::JsonToSettings(const json& j)
{
	...
	configmanager::GetJsonValue(j, settings::AL_rgbSpeed, "AL_rgbSpeed");
	...
	configmanager::GetJsonValue(j, settings::Reach_Chance, "Reach_Chance");
	...
	configmanager::GetJsonValue(j, settings::S_InWater, "Sprint_InWater");
	configmanager::GetJsonValue(j, settings::S_InAir, "Sprint_InAir");
	configmanager::GetJsonValue(j, settings::S_WhenStill, "Sprint_WhenStill");
	...
	configmanager::GetJsonValue(j, settings::BA_SneakDelay, "BA_SneakDelay");
	configmanager::GetJsonValue(j, settings::BA_UnSneakDelay, "BA_UnSneakDelay");
	...
	// Inventory Sorter
	configmanager::GetJsonValue(j, settings::IS_Enabled, "IS_Enabled");
	configmanager::GetJsonValue(j, settings::IS_Key, "IS_Key");
	configmanager::GetJsonValue(j, settings::IS_Delay, "IS_Delay");
...
{
	std::string path = configmanager::GetAirV1Path() + "/configs/";
...
std::string configmanager::GetAirV1Path()
{
	std::string path = configmanager::GetDocumentsPath() + "/AirV1/";
...
{
	std::string filePath = configmanager::GetAirV1Path() + "friends.json";
...
bool configmanager::SaveFriends()
{
	...
	std::string dirPath = configmanager::GetAirV1Path();
