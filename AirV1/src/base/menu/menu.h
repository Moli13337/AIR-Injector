...
struct Menu
{
	...
	static inline bool useGlassmorphism = true; // Enable glassmorphism UI
	...
	static inline ImTextureID combatIconTexture = nullptr;
	static inline ImTextureID movementIconTexture = nullptr;
	static inline ImTextureID visualIconTexture = nullptr;
	static inline ImTextureID utilityIconTexture = nullptr;
	static inline ImTextureID friendsIconTexture = nullptr;

	static void SetupImgui();
	static void SetupStyle();
	static void LoadIconTextures();
	static void CleanupIconTextures();
	static ImTextureID LoadTextureFromFile(const char* filename);

	static void RenderMenu();

	static void MouseClicked(int button, int action, int mods);
	static void MouseReleased(int button, int action, int mods);
	static void MouseDragged(int button, int action, int mods);
	static void KeyPressed(int key, int action, int mods);

	static void SaveFramePositions();
	static void LoadFramePositions();
