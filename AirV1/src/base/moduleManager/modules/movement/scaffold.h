...
class Scaffold : public ModuleBase
{
public:
...
private:
	...
	bool m_sneakQueued = false;
	bool m_unsneakQueued = false;
	std::chrono::time_point<std::chrono::steady_clock> m_sneakRequestTime;
	std::chrono::time_point<std::chrono::steady_clock> m_unsneakRequestTime;
};
