...
The reason why this is done is because if you notice while using AirV1's aim assist, you're free to move your pitch up and down when targetting a player,
...
For now, if you want to use AirV1, just use it with weak settings.
...
void AimAssist::Update()
{
	...
	// AirV1/src/base/util/math/Math.cpp
