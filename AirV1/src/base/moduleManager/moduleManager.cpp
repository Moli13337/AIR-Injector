...
#include "modules/utility/clientSpoofer.h"
#include "modules/utility/weapon.h"
#include "modules/utility/selfDestruct.h"
...
void ModuleManager::Init()
{
	...
	m_modules.push_back(std::make_unique<ClientSpoofer>());
	m_modules.push_back(std::make_unique<Weapon>());
	m_modules.push_back(std::make_unique<SelfDestruct>());
	...
	try
	{
		if (StrayCache::clientBrandRetriever_getClientModName != nullptr && ClientSpoofer::GetClientModName_callback != nullptr)
		{
			bool hookResult = JavaHook::Hook(StrayCache::clientBrandRetriever_getClientModName, ClientSpoofer::GetClientModName_callback);
